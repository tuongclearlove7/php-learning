    ...
    <div class="row">
       <form action="" method="post" class="col-md-4">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="gioitinh" id="gioitinh" class="form-control" placeholder="" aria-describedby="helpId">          
        </div>
        <div class="mb-3">
        ...
        <button type="submit" name="action" value="save_student" class="btn btn-primary">Save</button>
       </form>       
    </div>
    </div>
    </div>
