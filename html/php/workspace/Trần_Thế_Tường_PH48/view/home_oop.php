        ...
        <main>
            ...
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                ...
                <!-- <form action="" method="post">
                    <div class="mb-3">
                        <label for="" class="form-label">Tìm sản phẩm giá cao nhất</label>
                        <input type="text"
               ...
               <?php require('./view/add_product.php'); ?>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>Name product</th>
                        ...
                        <tbody>
                        <?php if (isset($list_obj_product)): ?>
                            <?php foreach ($list_obj_product as $key => $value):?>
                                <tr>
                ...
                <form action="" method="post">
                        <button type="submit" class="btn btn-primary" 
                        name="action" value="find_max_price">Tìm sản phẩm có giá cao nhất</button>
                </form> 

                <h1><?php echo $product_max_price; ?></h1>
                </div>
        </main>
        <footer>
            <h1>FOOTER</h1>
