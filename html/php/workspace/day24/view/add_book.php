    ...
    <div class="row">
       <form action="" method="post" class="col-md-4">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="publishyear" id="publishyear" class="form-control" placeholder="" aria-describedby="helpId">          
        </div>
        <div class="mb-3">
          <label for="" class="form-label">product</label>
          <input type="text" name="production" id="production" class="form-control" placeholder="" aria-describedby="helpId">          
        </div>
