...
<body>
    <div class="container">
        <a class="btn btn-primary" href="?controller=homepage" role="button">Home</a>

        <a class="btn btn-primary" href="?controller=add_data" role="button">Thêm mới</a>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td><a href="?controller=show_data&category_id=<?php echo $value['category_id']?>">
